...
## Adding Content  
Before talking about what *should* go into a repo, we'll first look at how to add files technically/generally and get them to GitHub.  
...
Outside of RStudio Terminal, CLI can be performed for any git directory.
...
### Needed Repo Stuff  
Here's a list of a few standard items to have in the repo: [GH Repo Components](https://geoepi.github.io/Notebook/repo_components.html)   
...
A main benefit of integrating git and RStudio isn't to have another option for linking to Git, rather it's to efficiently use git as part of normal coding.  
